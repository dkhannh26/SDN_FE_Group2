...
// import { createSize, editSize, getSize } from '../../services/size.service';
...
//         if (type === 'create') {
//             createSize(discount, navigate)
//         } else {
//             editSize(id, discount, navigate)
//         }
//     };

//     useEffect(() => {
//         if (type === 'edit') getSize(id, dayjs, form)
//     }, [id, type, form])
