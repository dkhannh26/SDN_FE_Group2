...
// import { getListSize } from '../../services/size.service';
...
//                         <Button danger shape="round" icon={<DeleteOutlined />} onClick={() => showDeleteConfirm(_id, messageApi, getListSize, setSize)} ></Button>
//                     </Space>
//                 )
//             },
//             width: '5%',
...
//                     <Button onClick={() => navigate(SIZE_URL.CREATE)}>Insert</Button>
//                 </Col>
//             </Flex>
