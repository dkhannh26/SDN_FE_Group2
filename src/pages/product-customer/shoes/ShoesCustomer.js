...
import { getListShoes, getListShoesDecrease, getListShoesIncrease } from '../../../services/product/shoes.service';
                        ...
                        return (
                            <Col span={6}>
                                <Card
                                    ...
                                    cover={<img alt="example" style={{ width: 258, height: 270 }} src={`http://localhost:3000${item.shoesImg}`} />}
                                >
                                    <Meta
                                        title={item.shoesName}
                                        description={
                                            <>
                                                <p>Giá gốc: {item.shoesPrice.toLocaleString('vi-VN')}₫</p>
                                                {item.shoesDiscountPercent ?
                                                    <p>Giá khuyến mãi:{' '}
                                                        {(item.shoesPrice - (item.shoesPrice * item.shoesDiscountPercent / 100)).toLocaleString('vi-VN')}₫ (-{item.shoesDiscountPercent}%)
                                                    </p>
                                                    :
